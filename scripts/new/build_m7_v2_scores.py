...
def compute_structure(feature: dict[str, Any]) -> dict[str, float]:
    ...
    if len(weekly_prices) >= 26:
        ...
        if sxx > 0:
            ...
            structure_r2_linear = _calc_r2(ys, linear_hat)
            ...
            if coeffs is not None:
                ...
                structure_r2_quadratic = _calc_r2(ys, quadratic_hat)
            ...
            if slxx > 0:
                ...
                structure_r2_logarithmic = _calc_r2(ys, log_hat)

            # Best structure model selection
            candidates = [
                ("linear", structure_r2_linear),
                ("quadratic", structure_r2_quadratic),
                ("logarithmic", structure_r2_logarithmic),
            ]
            ...
            if linear_hat:
                ...
                stability = max(0.0, min(10.0, (structure_r2_linear or 0.0) * 10.0 - 0.05 * dispersion))
    ...
    structure_score = clamp(safe_num(best_structure_r2, 0.0) * 10.0, 0.0, 10.0)
    return {
        "raw": structure_raw,
        ...
        "stability": stability,
        "r2": r2,
        "structure_r2_linear": structure_r2_linear,
        "structure_r2_quadratic": structure_r2_quadratic,
        "structure_r2_logarithmic": structure_r2_logarithmic,
        # backward-compatible aliases
        "linear_r2": structure_r2_linear,
        "quadratic_r2": structure_r2_quadratic,
        "logarithmic_r2": structure_r2_logarithmic,
    ...
    try:
        ...
        for sym in symbols:
            ...
            rows_out.append({
                ...
                "structure_score": round2(structure["structure_score"]),
